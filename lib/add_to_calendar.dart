// ignore_for_file: prefer_const_constructors, library_private_types_in_public_api, empty_constructor_bodies, prefer_const_literals_to_create_immutables, unused_element, unnecessary_string_interpolations, unused_local_variable, override_on_non_overriding_member, use_key_in_widget_constructors
          ...
          child: Column(
            ...
            children: <Widget>[
              TextFormField(
                ...
                validator: (title) => title != null && title.isEmpty ? 'Add a tittle' : null, 
    ...
    DateTime initialDate, {
      ...
      if(pickDate){
        final date = await showDatePicker(
          context: context, initialDate: initialDate, firstDate: firstDate ?? DateTime.now(), lastDate: DateTime(2025));
