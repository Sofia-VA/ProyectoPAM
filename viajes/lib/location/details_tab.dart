        ...
        Container(
            ...
            child: BlocBuilder<LocationBloc, LocationState>(
              builder: (context, state) {
                if (state is LoadingDetailsState || state is LocationInitial) {
                  return Text('Load');
                } else {
                  return Column(
                    children: [
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 3),
              Text("${widget.location['averageStars']}"),
            ],
          ),
          SizedBox(width: 10),
          Row(
      ...
      Container(
        ...
        child: ReadMoreText(
          (widget.location['description'] == null ||
              ...
              ? 'There is no place description so far'
              : widget.location['description'],
          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 5),
                Text("${widget.location['experiencesCount']}"),
              ],
            ),
          ],
        ),
